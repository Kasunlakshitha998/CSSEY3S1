...
const {
  ...
  // Mock the DoctorAvailability model
  ...
  describe('Doctor Availability Controller', () => {
    ...
    describe('createDoctorAvailability', () => {
      it('should create a new doctor availability and return it', async () => {
        ...
        const savedAvailability = { _id: '123', ...availabilityData };
    ...
    describe('getAllDoctorAvailabilities', () => {
      ...
      it('should throw an error when fetching doctor availabilities fails', async () => {
        DoctorAvailability.find.mockRejectedValue(new Error('Fetch failed'));
  
        await expect(getAllDoctorAvailabilities()).rejects.toThrow(
          'Error fetching doctor availabilities: Fetch failed'
        );
      });
    });
